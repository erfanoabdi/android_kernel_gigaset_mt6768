...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK                = 255;//300;//258;
...
struct LCM_DRIVER gc9702_hdplus_dsi_vdo_incell_xingyi_lcm_drv =
{
    .name			= "gc9702_hdplus_dsi_vdo_incell_xingyi",
