...
//Blank select 2F 
        ...
        {0x41,2,{0x5A,0x09}},
        {0x80,16,{0x5A,0x51,0xB5,0x2A,0x6C,0xC5,0x4A,0x01,0x40,0x62,0x0F,0x82,0x20,0x08,0xF0,0xB7}},
        {0x90,16,{0x00,0x24,0x42,0x0A,0xE3,0x91,0xA4,0xF0,0xA1,0xE4,0x61,0x25,0x69,0xB5,0x26,0x00}},
        ...
        {0x41,2,{0x5A,0x0A}},
        {0x80,16,{0xFF,0x51,0x29,0x03,0x00,0x06,0x0C,0x14,0x1E,0x2A,0x2A,0x57,0x04,0x47,0xE4,0xA1}},
        {0x90,16,{0xA4,0x6C,0x64,0x51,0x3D,0x2A,0x19,0x0B,0x00,0x06,0x0C,0x14,0x1E,0x2A,0x2A,0x57}},
        {0xA0,13,{0x04,0x47,0xE4,0xA1,0xA4,0x6C,0x64,0x51,0x3D,0x2A,0x19,0x0B,0x00}},
        {0x41,2,{0x5A,0x0B}},
        {0x80,16,{0x00,0x00,0x20,0x44,0x08,0x00,0x60,0x47,0x00,0x00,0x10,0x22,0x04,0x00,0xB0,0x23}},
        {0x90,2,{0x15,0x00}},
        {0x41,2,{0x5A,0x0C}},
        {0x80,16,{0xFA,0x68,0x68,0x81,0x2F,0x6E,0x10,0x04,0x00,0x60,0x15,0x00,0x50,0x15,0x56,0x51}},
        {0x90,16,{0x15,0x55,0x61,0x15,0x00,0x60,0x15,0x00,0x50,0x15,0x56,0x51,0x15,0x55,0x61,0x95}},
        {0xA0,16,{0xAB,0x18,0x00,0x05,0x00,0x05,0x00,0x05,0x80,0x4C,0x29,0x84,0x52,0x01,0x09,0x00}},
        {0xB0,2,{0x00,0x00}},
        {0x41,2,{0x5A,0x0D}},
        ...
        {0x41,2,{0x5A,0x0F}},
        {0x80,16,{0xB5,0x05,0x82,0xE0,0x11,0xA0,0xC3,0x08,0x52,0x51,0x58,0x49,0x03,0x52,0x4C,0x4C}},
        ...
        {0xD0,16,{0x42,0x88,0x20,0x09,0x10,0x00,0x40,0x80,0x24,0x31,0x04,0x41,0x06,0x00,0x00,0x00}},
        ...
        {0x41,2,{0x5A,0x14}},
        {0x80,16,{0x01,0x02,0x41,0x36,0xE9,0xEF,0xF7,0xFB,0xFD,0x7E,0x00,0x00,0x00,0x7C,0xC5,0x87}},
        {0x90,16,{0x26,0x3D,0x20,0x36,0x34,0xE9,0x01,0x71,0xA1,0x49,0x0F,0x88,0x09,0x4D,0x7A,0x00}},
        {0xA0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
        {0xB0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x9C,0xAF,0xF9,0x2A,0x00,0x40,0xA1}},
        {0xC0,16,{0x50,0x78,0x07,0xF8,0xF5,0x90,0x51,0x1C,0x6F,0x00,0xBF,0x1E,0x32,0x8A,0xE3,0x05}},
        {0xD0,16,{0xE0,0xD7,0x43,0x46,0x71,0xBC,0x02,0xFC,0x7A,0xC8,0x28,0x8E,0x77,0x81,0x5F,0x0F}},
        {0xE0,16,{0x19,0xC5,0xF1,0x26,0xF0,0xEB,0x21,0xA3,0x38,0xDE,0x03,0x7E,0x3D,0x64,0x14,0xC7}},
        {0xF0,16,{0x5B,0xC0,0xAF,0x87,0x8C,0xE2,0x78,0x01,0xBF,0xDF,0x08,0x00,0x00,0x00,0x00,0x00}},
        {0x41,2,{0x5A,0x15}},
        {0x80,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x10,0xD8,0xE0,0xF7}},
        {0x90,16,{0xF3,0x00,0xF9,0x4A,0xC4,0xA8,0xD5,0x06,0x91,0x91,0x17,0x31,0x6A,0xB5,0x41,0x64}},
        {0xA0,16,{0x64,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
        {0xB0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x12,0x00,0xF0,0x00,0x88,0x76,0x35,0x2D}},
        {0xC0,16,{0x69,0x15,0x0C,0xC5,0x01,0xD5,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0x43,0x15}},
        {0xD0,16,{0xA2,0x56,0x06,0x21,0x00,0xD0,0x6C,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0x76,0x35}},
        {0xE0,16,{0x29,0x68,0x05,0x08,0x84,0x01,0xD5,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0x43}},
        {0xF0,16,{0x55,0xB2,0x56,0x47,0x31,0x04,0xD0,0x6C,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0x5B,0xC0}},
        {0x41,2,{0x5A,0x16}},
        ...
        {0x41,2,{0x5A,0x22}},
        {0x80,13,{0x2D,0xD3,0x00,0x00,0x00,0x54,0x55,0x55,0x01,0x00,0x50,0x9F,0x00}},
        {0x41,2,{0x5A,0x23}},
        {0x80,16,{0x01,0x05,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
        {0x90,12,{0xFF,0x0F,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0xFF,0x07,0x35}},
        {0x41,2,{0x5A,0x24}},
        {0x80,16,{0x00,0x03,0x00,0xFF,0xFF,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xB0,0x2A}},
        {0x90,16,{0x5A,0x5A,0x5A,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
		{0x42,1,{0x24}},
		{0x90,1,{0x00}},
		{0x41,2,{0x5A,0x2F}},
