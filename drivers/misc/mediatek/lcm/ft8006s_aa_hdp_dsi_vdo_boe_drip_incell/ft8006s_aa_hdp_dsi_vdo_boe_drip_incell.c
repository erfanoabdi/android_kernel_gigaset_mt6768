...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch     = 60;//45
	params->dsi.horizontal_frontporch    = 80;//48
	params->dsi.horizontal_active_pixel  = FRAME_WIDTH;
	/* params->dsi.ssc_disable = 1; */

	params->dsi.PLL_CLOCK                = 307;//320
...
struct LCM_DRIVER ft8006s_aa_hdp_dsi_vdo_boe_drip_incell_lcm_drv =
{
    .name			= "ft8006s_aa_hdp_dsi_vdo_boe_drip_incell",
