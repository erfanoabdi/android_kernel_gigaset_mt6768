...
//prize wyq 20191018 add chargepump backlight-start
#if defined(CONFIG_BACKLIGHT_SUPPORT_LM3697) || defined(CONFIG_BACKLIGHT_SUPPORT_AW99703)
extern int chargepump_set_backlight_level(unsigned int level);
#endif /* CONFIG_BACKLIGHT_SUPPORT_LM3697 */
//prize wyq 20191018 add chargepump backlight-end
