...
extern int curr_sensor_id;// prize add by zhuzhengjiang for camera 20201103 start
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	// prize add by zhuzhengjiang for camera 20201103 start
	if(curr_sensor_id ==2){
		*sensor_id = 0xFFFFFFFF;
		LOG_INF("current sensor idx is not match  physical idx\n");
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	// prize add by zhuzhengjiang for camera 20201103 end
