 ...
 *
 ****************************************************************************/
#ifndef __GC8034GMSMIPI_SENSOR_H__
#define __GC8034GMSMIPI_SENSOR_H__

/* SENSOR MIRROR FLIP INFO */
#define GC8034GMS_MIRROR_FLIP_ENABLE         1
#if GC8034GMS_MIRROR_FLIP_ENABLE
#define GC8034GMS_MIRROR		  0xc0
#define GC8034GMS_BIN_STARTY	  0x04
#define GC8034GMS_BIN_STARTX	  0x05
#define GC8034GMS_FULL_STARTY	  0x08
#define GC8034GMS_FULL_STARTX	  0x0b
#else
#define GC8034GMS_MIRROR		  0xc0
#define GC8034GMS_BIN_STARTY	  0x04
#define GC8034GMS_BIN_STARTX	  0x05
#define GC8034GMS_FULL_STARTY	  0x08
#define GC8034GMS_FULL_STARTX	  0x09
#endif
...
/* SENSOR OTP INFO */
#define GC8034GMSOTP_FOR_CUSTOMER       1
/* Please do not enable the following micro definition, if you are not debuging otp function*/
#define GC8034GMSOTP_DEBUG              1

#define DD_WIDTH                     3284
#define DD_HEIGHT                    2464
#define GC8034GMS_OTP_ID_SIZE           9
#define GC8034GMS_OTP_ID_DATA_OFFSET    0x02
...
struct gc8034gms_dd_t {
	kal_uint16 x;
	kal_uint16 y;
	kal_uint16 t;
};

struct gc8034gms_otp_t {
	kal_uint8 otp_id[GC8034GMS_OTP_ID_SIZE];
	kal_uint8  dd_cnt;
	kal_uint8  dd_flag;
	struct gc8034gms_dd_t dd_param[160];
	kal_uint8  reg_flag;
	kal_uint8  reg_num;
