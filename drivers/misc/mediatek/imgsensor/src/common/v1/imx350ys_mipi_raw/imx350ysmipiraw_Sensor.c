...
#include "imx350ysmipiraw_Sensor.h"

/************************Modify Following Strings for Debug********************/
#define PFX "IMX350YS_camera_sensor"
#define LOG_1 LOG_INF("IMX350,MIPI 4LANE\n")
/************************   Modify end    *************************************/

#undef IMX350YS_24_FPS
...
static BYTE imx350ys_SPC_data[352] = { 0 };
...
//prize add by lipengpeng 20220117 start 
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_MONO,
//prize add by lipengpeng 20220117 end 
...
#define IMX350YSMIPI_MaxGainIndex (389)
kal_uint16 imx350ysMIPI_sensorGainMapping[IMX350YSMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 16},
	{66, 32},
	{67, 46},
...
static void imx350ys_set_pd_focus_area(MUINT32 startpos, MUINT32 size)
{
...
static void imx350ys_get_pdaf_reg_setting(
...
static void imx350ys_set_pdaf_reg_setting(
	MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx350ys_apply_SPC(void)
{
	...
	imx350ys_read_SPC(imx350ys_SPC_data);

	tosend = 0;
	puSendCmd[tosend++] = (char)(start_reg >> 8);
	puSendCmd[tosend++] = (char)(start_reg & 0xFF);
	memcpy((void *)&puSendCmd[tosend], imx350ys_SPC_data, 352);
	tosend += 352;
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (iI = 0; iI < IMX350YSMIPI_MaxGainIndex; iI++) {
		if (gain <= imx350ysMIPI_sensorGainMapping[iI][0])
			return imx350ysMIPI_sensorGainMapping[iI][1];
	}

	return imx350ysMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx350ys_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_imx350ys_zvhdr_on[] = {
	0x30b1, 0x00,
	0x30c6, 0x00,
	0x30b2, 0x00,
	0x30b3, 0x00,
...
kal_uint16 addr_data_pair_imx350ys_zvhdr_off[] = {
	0x30b4, 0x00,
	0x30b5, 0x00,
	0x30b6, 0x00,
	0x30b7, 0x00,
...
static kal_uint16 zvhdr_setting(void)
{
	...
	if (imgsensor.hdr_mode == 9) {
		imx350ys_table_write_cmos_sensor(addr_data_pair_imx350ys_zvhdr_on,
		sizeof(addr_data_pair_imx350ys_zvhdr_on) / sizeof(kal_uint16));
	} else {
		imx350ys_table_write_cmos_sensor(addr_data_pair_imx350ys_zvhdr_off,
		sizeof(addr_data_pair_imx350ys_zvhdr_off) / sizeof(kal_uint16));
	}
	return 0;

}

kal_uint16 addr_data_pair_init_imx350ys[] = {
	0x0136, 0x18,
	0x0137, 0x00,
...
{
	LOG_INF("E\n");
	imx350ys_table_write_cmos_sensor(addr_data_pair_init_imx350ys,
		sizeof(addr_data_pair_init_imx350ys)/sizeof(kal_uint16));

	/*enable temperature sensor, TEMP_SEN_CTL:*/
	write_cmos_sensor(0x0138, 0x01);
}    /*    sensor_init  */

kal_uint16 addr_data_pair_preview_imx350ys[] = {
	0x0100, 0x00,
...
{
	imx350ys_table_write_cmos_sensor(addr_data_pair_preview_imx350ys,
	sizeof(addr_data_pair_preview_imx350ys) / sizeof(kal_uint16));
	/* zvhdr_setting(); */
}				/*    preview_setting  */

kal_uint16 addr_data_pair_capture_imx350ys[] = {
	0x0100, 0x00,
/*24fps*/
#ifdef IMX350YS_24_FPS
	0x0112, 0x0A,
...
kal_uint16 addr_data_pair_capture_imx350ys_pdaf_on[] = {
	/*PDAF*/
	/*PD_OUT_EN=1 */
	0x3E37, 0x01,
	/*AREA MODE */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx350ys_table_write_cmos_sensor(addr_data_pair_capture_imx350ys,
	sizeof(addr_data_pair_capture_imx350ys) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif

	if (imgsensor.pdaf_mode == 1) {
		imx350ys_table_write_cmos_sensor(
			addr_data_pair_capture_imx350ys_pdaf_on,

		sizeof(
		addr_data_pair_capture_imx350ys_pdaf_on) / sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_video_imx350ys[] = {
	0x0100, 0x00,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx350ys_table_write_cmos_sensor(addr_data_pair_video_imx350ys,
	sizeof(addr_data_pair_video_imx350ys) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif
}

kal_uint16 addr_data_pair_hs_video_imx350ys[] = {
	0x0100, 0x00,
...
{
	imx350ys_table_write_cmos_sensor(addr_data_pair_hs_video_imx350ys,
	sizeof(addr_data_pair_hs_video_imx350ys) / sizeof(kal_uint16));
	zvhdr_setting();
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			*sensor_id = return_lot_id_from_otp() + 3;
			/* return_sensor_id(); */
...
static kal_uint32 open(void)
{
	...
	KD_SENSOR_PROFILE("imx350ys_open_1");
	...
	KD_SENSOR_PROFILE("imx350ys_open_2");
	return ERROR_NONE;
} /* open */
...
static kal_uint32 imx350ys_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		imx350ys_read_DCC((kal_uint16) (*feature_data),
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx350ys_awb_gain(pSetSensorAWB);
		break;
