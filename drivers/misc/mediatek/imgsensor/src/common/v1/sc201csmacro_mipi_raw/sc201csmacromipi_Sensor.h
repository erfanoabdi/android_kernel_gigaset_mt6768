 ...
 *
 ****************************************************************************/
#ifndef _SC201CSMACROMIPI_SENSOR_H
#define _SC201CSMACROMIPI_SENSOR_H

/* SENSOR MIRROR FLIP INFO */
#define SC201CSMACRO_MIRROR_NORMAL    0
#define SC201CSMACRO_MIRROR_H         0
#define SC201CSMACRO_MIRROR_V         0
#define SC201CSMACRO_MIRROR_HV        1

#if SC201CSMACRO_MIRROR_NORMAL
#define SC201CSMACRO_MIRROR	        0x00
#elif SC201CSMACRO_MIRROR_H
#define SC201CSMACRO_MIRROR	        0x06
#elif SC201CSMACRO_MIRROR_V
#define SC201CSMACRO_MIRROR	        0x60
#elif SC201CSMACRO_MIRROR_HV
#define SC201CSMACRO_MIRROR	        0x66
#else
#define SC201CSMACRO_MIRROR 0x00
#endif

/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define SC201CSMACRO_SENSOR_GAIN_BASE             0x400
#define SC201CSMACRO_SENSOR_GAIN_MAX              (3175 * SC201CSMACRO_SENSOR_GAIN_BASE /100)
#define SC201CSMACRO_SENSOR_GAIN_MAX_VALID_INDEX  5  
