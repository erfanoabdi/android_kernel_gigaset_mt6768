 ...
 *
 ****************************************************************************/
#ifndef _S5K2P7GMSMIPI_SENSOR_H
#define _S5K2P7GMSMIPI_SENSOR_H
...
extern bool read_2P7GMS_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);

extern int iBurstWriteReg_multi(u8 *pData, u32 bytes,
		u16 i2cId, u16 transfer_length, u16 timing);

#endif  /*_S5K2P7GMSMIPI_SENSOR_H*/
