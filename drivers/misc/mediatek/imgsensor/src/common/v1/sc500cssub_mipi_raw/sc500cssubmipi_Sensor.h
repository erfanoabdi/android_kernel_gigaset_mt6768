 ...
 *
 ****************************************************************************/
#ifndef _SC500CSSUBMIPI_SENSOR_H
#define _SC500CSSUBMIPI_SENSOR_H

/* SENSOR MIRROR FLIP INFO */
#define SC500CSSUB_MIRROR_FLIP_ENABLE    1
#if SC500CSSUB_MIRROR_FLIP_ENABLE
#define SC500CSSUB_MIRROR 0x66
#else
#define SC500CSSUB_MIRROR 0x00
#endif

/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define SC500CSSUB_SENSOR_GAIN_BASE             0x400
#define SC500CSSUB_SENSOR_GAIN_MAX              (800 * SC500CSSUB_SENSOR_GAIN_BASE / 100)
#define SC500CSSUB_SENSOR_GAIN_MAX_VALID_INDEX  4
#define SC500CSSUB_SENSOR_GAIN_MAP_SIZE         4
#define SC500CSSUB_SENSOR_DGAIN_BASE            0x400

#if 0

/* SENSOR OTP INFO */
#define SC500CSSUBOTP_FOR_CUSTOMER    0
