...
/****************************   Modify end    *******************************************/
#define BF2253_MIRROR_ENABLE 1
#define BF2253_FLIP_ENABLE 1
...
#if BF2253_MIRROR_ENABLE	
//	write_cmos_sensor(0x00, 0x2E);
	write_cmos_sensor(0x00, read_cmos_sensor(0x00) | 0x08);  //prize add by zhuzhengjiang for mirror & flip [3]:mirror 0:normal 1:mirror  [2]:flip  0:normal  1:flip
#else
#endif
#if BF2253_FLIP_ENABLE
