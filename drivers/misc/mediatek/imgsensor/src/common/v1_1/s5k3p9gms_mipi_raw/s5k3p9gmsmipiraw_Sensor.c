...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{2304, 1728, 512, 504, 1280, 720, 1280, 720, 0000, 0000, 1280, 720, 0, 0, 2304, 1728},	/* hight speed video */
...
static kal_uint32 return_sensor_id(void)
{
	...
	LOG_INF("imgsensor_info.sensor_id:0x%x,module_id:0x%x\n", sensor_id,module_id);
	if(module_id > 0)
	{
		module_id = 1;
	}
                             ...
                             UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		// prize add for its:test_sensor_fusion start 
		case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
			*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6080000;
			break;
		// prize add for its:test_sensor_fusion end
		// huangjiwu for  captrue black --begin	
