...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.linelength = 16448, /*//0x3AB0*/
		.framelength = 3888, /*//0x10A0*/
		.startx = 0,
		.starty = 0,
	...
	.hs_video = {/*slow motion 1080p 240fps (4SUMA2A2) */
		.pclk = 1920000000,
		.linelength = 6560,   /*0x0F40*/
		.framelength = 1216,   /*0x0800*/
		.startx = 0,
		.starty = 0,
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gb, //影像组 要求更新掉SENSOR_OUTPUT_FORMAT_RAW_Gb //SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gr SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gb,SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_B,SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_R,SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gr
...
static struct imgsensor_struct imgsensor = {
	.mirror = IMAGE_HV_MIRROR, /* mirrorflip information */  //IMAGE_NORMAL  IMAGE_H_MIRROR  IMAGE_V_MIRROR  IMAGE_HV_MIRROR
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (0xA0 == module_id && 0x01 <= revision) {
		sensor_id += 1;
	}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain < imgsensor_info.min_gain || gain > imgsensor_info.max_gain) {
		...
		else if (imgsensor_info.max_gain)
...
UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6000000;// 3000000 prize add for its:test_sensor_fusion start 
		break;
