...
static ssize_t cdfinger_fp_chip_status_show(struct device* dev,
									 struct device_attribute* attr, char* buf)
{
   int len = 0;
...
static DEVICE_ATTR(fp_chip_status, S_IRUGO, cdfinger_fp_chip_status_show, NULL);
