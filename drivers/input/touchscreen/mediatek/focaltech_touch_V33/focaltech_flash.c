...
static void fts_fwupg_work(struct work_struct *work)
{
    ...
    struct fts_upgrade *upg = fwupgrade;
	u8 chip_id = 0;
	u8 ctp_fw_version = 0;  //prize add by wangfei for read fw version from fw 20210727
...
//prize add by wangfei for read TP fw version from fw 20210727 start
    #if defined(CONFIG_PRIZE_HARDWARE_INFO)
    ...
    #endif
//prize add by wangfei for read TP fw version from fw 20210727 end
    }
