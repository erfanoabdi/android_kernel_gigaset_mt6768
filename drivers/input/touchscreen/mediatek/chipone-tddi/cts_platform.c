...
static void cts_plat_touch_event_timeout(struct timer_list *t)
{
	struct cts_platform_data *arg = from_timer(arg, t, touch_event_timeout_timer);
...
#ifdef CFG_CTS_FORCE_UP
/* prize modify for kernel-4.19 start */ 
	timer_setup(&pdata->touch_event_timeout_timer, 
        cts_plat_touch_event_timeout, 0);
//    setup_timer(&pdata->touch_event_timeout_timer, 
//        cts_plat_touch_event_timeout, (unsigned long)pdata); // for kernel-4.9
/* prize modify  end */
#endif
